package com.BJSS.framework.stepdefinitions;

import com.BJSS.framework.helpers.ScreenshotHelper;
...
import com.BJSS.framework.pageobjects.cms.*;
import com.BJSS.framework.pageobjects.gui.QuickViewPage;
...
public class PurchaseItemsSteps {
    ...
    public PurchaseItemsSteps
        (CartSummaryPage CartSummaryPage, HomePage HomePage, MyAccountPage MyAccountPage,
         ...
         OrderHistoryPageModel OrderHistoryPageModel, ScreenshotHelper ScreenshotHelper)
    {
    ...
    @After
    public void grabScreenshotOfFailedScenario(Scenario scenario){
        screenshotHelper.embedScreenshot(scenario);
    }
}