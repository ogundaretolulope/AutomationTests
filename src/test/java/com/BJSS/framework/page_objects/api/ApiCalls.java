package com.BJSS.framework.page_objects.api;
...
public class ApiCalls extends ApiHelper {
    ...
    public static Response createUser(List<UsersDetailsModel> usersDetailsModels, String PATH){
        ...
        return getPostResponse(userData, PATH);
    }
    ...
    public static Response getPostResponse(UserDetailModel userData, String PATH){
